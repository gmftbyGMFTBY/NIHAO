/********************************************************************************
 * Files         : friendbox.c
 * Description   : Class of friendbox for chat.c
 * Author        : Guojiayan
...
/*******************************************************************************
 * Description   : talk_friendbox struct
 * 
 * New widget    : GtkWidget *utalk_friendbox_new ();
 * Get name label: const gchar *utalk_friendbox_get_name_label ();
 * Get name      : const gchar *utalk_friendbox_get_name ();
 * Set name      : void utalk_friendbox_set_name ();
 ******************************************************************************/
...
/*******************************************************************************
 * Description   : utalk_friendbox_with_msg struct
 * 
 * New widget    : GtkWidget *utalk_friendbox_with_msg_new ();
 * Get name      : const gchar *utalk_friendbox_with_msg_get_name ();
 * Set name      : void utalk_friendbox_with_msg_set_name ();
 * Get message   : const gchar *utalk_friendbox_with_msg_get_msg ();
 * Set message   : void utalk_friendbox_with_msg_set_msg ();
 ******************************************************************************/
